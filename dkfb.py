...
def siapa():
	os.system('clear')
	Aran = raw_input("\033[1;97mSapa arane sira ? \033[1;91m: \033[1;92m")
	if aran =="":
...
def loginSC():
	...
	if username =="dina" and password =="tompel":
		print"\033[1;96m[✓] \033[1;92mUdah login kontol"
		time.sleep(1)
		login()
	else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/frontal gaming')
				menu()
